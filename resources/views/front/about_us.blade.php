...
@section('title','سامانه آموزش آنلاین_درباره ما')
...
@section('contents')
    ...
    <section class="container mb-5">
        ...
        <div id="contents">
            ...
            <!--about us-->
            <h5>درباره سامانه آموزش آنلاین</h5>

            <p>
                سامانه آموزش آنلاین با بهره گیری از بهترین و بروزترین سیستم آموزش مجازی، با هدف ارائه آموزش های مجازی از سال 1402 کار خود را شروع کرد.
            ...
            <div class="links w-100">
                <nav class="nav px-0  flex-column">
                    <li class="nav-link ps-0" href="#">
                        ...
                        <p class="text-muted text-nowrap">شماره تماس : 09910001122</p>
                        <p class="text-muted text-nowrap">شماره دفتر : 0743440000 (پاسخگویی فقط در ساعات اداری)</p>
                        <p class="text-muted text-nowrap">ایتا : @mr-eaita</p>
                    </li>
                    <li class="nav-link ps-0" href="#">
                        <h6 class="text-dark fw-medium mb-3 fs-55">
                            <i class="fa fa-phone fa-sm"></i>
            ...
            <!--about us-->
            <h5>قوانین استفاده از سامانه</h5>
